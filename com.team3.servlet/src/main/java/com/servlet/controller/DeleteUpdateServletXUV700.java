...
public class DeleteUpdateServletXUV700 extends HttpServlet{

	private static final long serialVersionUID = 1L;
	
	public DeleteUpdateServletXUV700() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result;
		try {
			result = imp.deleteXUV700(mahindra);
			RequestDispatcher success = request.getRequestDispatcher("/Delete.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result;
		try {
			result = imp.updateXUV700(entity);
		
		
		HttpSession session = request.getSession();
		session.setAttribute("updateXUV700", entity);
