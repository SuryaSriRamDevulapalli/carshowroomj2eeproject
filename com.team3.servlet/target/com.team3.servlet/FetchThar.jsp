...
<h1 align = "center">The below are the details retrieved from Mahindra Database for Thar!!</h1>
<body>
    <h2 style="margin-top: 20px;">Thar Details:</h2>
    <table style="margin-top: 10px;">
<%
Object obj = session.getAttribute("FetchThar");
if(obj == null){
